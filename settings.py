...
if DEVELOPMENT_MODE:
    ...
    DEBUG = False
    MEDIA_URL = 'http://static.sigurdspermfacts.com/'
    ADMIN_MEDIA_PREFIX = MEDIA_URL + '/admin/'
    DATABASE_ENGINE = 'postgresql_psycopg2'
    DATABASE_USER = 'xsperm'
    DATABASE_NAME = 'xsperm_db'
...
DEFAULT_FROM_EMAIL = 'noreply@sigurdspermfacts.com'
